...
// utilities/fridgeMenu.ts
export type FridgeItem = {
  id: string;        // "Rice", "Salmon", ...
  iconSrc: string;
};
...
export class FridgeMenu {
	...
	constructor(private items: FridgeItem[]) {}

	public setOnClose(fn: (picked: string | null) => void): void {
		this.onClose = fn;
	}
	...
	private onClose: ((picked: string | null) => void) | null = null;
